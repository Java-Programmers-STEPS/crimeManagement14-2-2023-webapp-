...
<li class=""><a href="about.jsp"><b>About</b> </a></li>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="AllCriminalRecords.jsp"><b>All Criminal Records</b></a></li>
								<li><a href="AllPostMortumReport.jsp"><b>All Post-Mortum Records</b></a></li>
								<li><a href="AllMostWanted.jsp"><b>Most Wanted Criminals List</b></a></li>
								<li><a href=""><b>Suspected Criminals List</b></a></li>
